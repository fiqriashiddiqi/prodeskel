                                        ...
                                        <form id="form-data" enctype="multipart/form-data">
                                            ...
                                            <div>
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <textarea id="elm1" name="tnc" required></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    <input type="file" class="filestyle" name="gambar" data-buttonname="btn-secondary" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <select class="form-control" id="type_voucher" name="jenis_voucher" required>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("form#form-data").submit(function(e) {
            ...
            var konfirmasi = confirm("Save Data?");
            if(konfirmasi){
                e.preventDefault();    
