                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-0 header-title">Membership Report</h4>
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <th>Years</th>
                                                <th>Month</th>
                                                <th>New Customer Register</th>
                                                <th>Total Member</th>
                                                <th>Member No Transaction</th>
                                                <th>Active User</th>
                ...
                <script type="text/javascript">
                    $(document).ready(function(){
                        ...
                        var table = $('#datatable-buttons').DataTable({
                            ...
                            "serverSide": true,
                            "ajax": {
                                "url" : "<?php echo URL_API;?>/api/v1/report-membership-datatables",
                                "type" : "POST",
                                "headers" : 
                                {
